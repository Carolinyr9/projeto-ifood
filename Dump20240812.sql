...
INSERT INTO `cardapio` VALUES (3703,1,0,0),(7498,1,0,0),(885,1,0,0),(7912,1,0,NULL),(2979,1,1946,NULL),(5134,1,3857,NULL),(8061,1,NULL,9081),(5128,1,4035,NULL),(8272,1,5393,NULL),(3061,1,6019,NULL),(7234,1,NULL,6972),(4091,1,NULL,2735),(1,1,6530,NULL),(1,1,8558,NULL),(1,1,NULL,837),(1,1,NULL,6864),(1,1,6883,NULL),(1,1,3494,NULL),(3703,1,0,0),(7498,1,0,0),(885,1,0,0),(7912,1,0,NULL),(2979,1,1946,NULL),(5134,1,3857,NULL),(8061,1,NULL,9081),(5128,1,4035,NULL),(8272,1,5393,NULL),(3061,1,6019,NULL),(7234,1,NULL,6972),(4091,1,NULL,2735),(1,1,6530,NULL),(1,1,8558,NULL),(1,1,NULL,837),(1,1,NULL,6864),(1,1,6883,NULL),(1,1,3494,NULL),(3703,1,0,0),(7498,1,0,0),(885,1,0,0),(7912,1,0,NULL),(2979,1,1946,NULL),(5134,1,3857,NULL),(8061,1,NULL,9081),(5128,1,4035,NULL),(8272,1,5393,NULL),(3061,1,6019,NULL),(7234,1,NULL,6972),(4091,1,NULL,2735),(1,1,6530,NULL),(1,1,8558,NULL),(1,1,NULL,837),(1,1,NULL,6864),(1,1,6883,NULL),(1,1,3494,NULL),(3703,1,0,0),(7498,1,0,0),(885,1,0,0),(7912,1,0,NULL),(2979,1,1946,NULL),(5134,1,3857,NULL),(8061,1,NULL,9081),(5128,1,4035,NULL),(8272,1,5393,NULL),(3061,1,6019,NULL),(7234,1,NULL,6972),(4091,1,NULL,2735),(1,1,6530,NULL),(1,1,8558,NULL),(1,1,NULL,837),(1,1,NULL,6864),(1,1,6883,NULL),(1,1,3494,NULL),(3703,1,0,0),(7498,1,0,0),(885,1,0,0),(7912,1,0,NULL),(2979,1,1946,NULL),(5134,1,3857,NULL),(8061,1,NULL,9081),(5128,1,4035,NULL),(8272,1,5393,NULL),(3061,1,6019,NULL),(7234,1,NULL,6972),(4091,1,NULL,2735),(1,1,6530,NULL),(1,1,8558,NULL),(1,1,NULL,837),(1,1,NULL,6864),(1,1,6883,NULL),(1,1,3494,NULL),(3703,1,0,0),(7498,1,0,0),(885,1,0,0),(7912,1,0,NULL),(2979,1,1946,NULL),(5134,1,3857,NULL),(8061,1,NULL,9081),(5128,1,4035,NULL),(8272,1,5393,NULL),(3061,1,6019,NULL),(7234,1,NULL,6972),(4091,1,NULL,2735),(1,1,6530,NULL),(1,1,8558,NULL),(1,1,NULL,837),(1,1,NULL,6864),(1,1,6883,NULL),(1,1,3494,NULL),(3703,1,0,0),(7498,1,0,0),(885,1,0,0),(7912,1,0,NULL),(2979,1,1946,NULL),(5134,1,3857,NULL),(8061,1,NULL,9081),(5128,1,4035,NULL),(8272,1,5393,NULL),(3061,1,6019,NULL),(7234,1,NULL,6972),(4091,1,NULL,2735),(1,1,6530,NULL),(1,1,8558,NULL),(1,1,NULL,837),(1,1,NULL,6864),(1,1,6883,NULL),(1,1,3494,NULL);
...
INSERT INTO `pedidos` VALUES (1,'[2735]','[6019]','aberto',2,2,3,1,90.75,'2024-08-10 21:01:12','2024-08-10 21:01:12'),(3,'[6972]','[null]','aberto',6,2,3,1,70.75,'2024-08-10 21:05:49','2024-08-10 21:05:49');
...
INSERT INTO `produto` VALUES (6972,'Refrigerante Coca-cola - 350ml','Lata de coca delícia!',9.50,1),(2735,'Refrigerante Fanta Uva - 350ml','Refrigerante Fanta Uva em lata',7.50,1),(837,'Suco de uva - 500ml','Suco de uva caseiro',10.90,1),(6864,'Suco de Laranja - 1L','Suco de laranja natural',19.70,1),(6972,'Refrigerante Coca-cola - 350ml','Lata de coca delícia!',9.50,1),(2735,'Refrigerante Fanta Uva - 350ml','Refrigerante Fanta Uva em lata',7.50,1),(837,'Suco de uva - 500ml','Suco de uva caseiro',10.90,1),(6864,'Suco de Laranja - 1L','Suco de laranja natural',19.70,1),(6972,'Refrigerante Coca-cola - 350ml','Lata de coca delícia!',9.50,1),(2735,'Refrigerante Fanta Uva - 350ml','Refrigerante Fanta Uva em lata',7.50,1),(837,'Suco de uva - 500ml','Suco de uva caseiro',10.90,1),(6864,'Suco de Laranja - 1L','Suco de laranja natural',19.70,1);
...
--
-- Dumping events for database 'bddelivery'
--
...
BEGIN
    INSERT INTO prato (id, nome, descricao, ingredientes, preco, id_restaurante)
    VALUES (v_id, v_nome, v_descricao, v_ingredientes, v_preco, v_id_restaurante);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    INSERT INTO produto (id, nome, descricao, preco, id_restaurante)
    VALUES (v_id, v_nome, v_descricao, v_preco, v_id_restaurante);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Selecionar_Cardapio`(IN `v_id` INT)
BEGIN
    SELECT id, id_restaurante, id_prato, id_produto FROM cardapio WHERE id = v_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `Selecionar_Carrinho`(IN `v_id` INT)
BEGIN
    SELECT id, id_prato, id_produto, id_restaurante, preco, endereco_entrega, quantidade 
    FROM carrinho WHERE id = v_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    SELECT id, status, id_carrinho, id_cliente, id_entregador, data_pedido, data_atualizacao
    FROM pedido
    WHERE id = v_id;
END ;;
DELIMITER ;
...
BEGIN
    SELECT id, nome, descricao, ingredientes, preco, id_restaurante
    FROM prato
    WHERE id = v_id;
END ;;
DELIMITER ;
...
BEGIN
    SELECT id, nome, descricao, preco, id_restaurante
    FROM produto
    WHERE id = v_id;
END ;;
DELIMITER ;
...
-- Dump completed on 2024-08-12 23:07:47
