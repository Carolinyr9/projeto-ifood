...
public class Pedido {
    ...
    public void editarItemPedido(ItemCardapio item) {
    	int index = verificarItem(item);
    	itens.get(index).editarItem();
    }

    public void excluirItemPedido(ItemCardapio item) {
    	int index = verificarItem(item);
    	itens.remove(index);
    }

    public void consultarItemPedido(ItemCardapio item) {
        int index = verificarItem(item);
        itens.get(index).toString();
    }
