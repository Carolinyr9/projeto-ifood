...
public class MenuBarEntregador extends Composite {
    ...
    public MenuBarEntregador(Composite parent, MainPage mainPage) {
		super(parent, SWT.NONE);
        createResourceManager();
        addTopBorderPaintListener();
        
        Path mapIconPath = Paths.get("src/assets/images/mapIcon.png").toAbsolutePath();
        ...
        mapIcon = new Image(display, mapIconPath.toString());
		...
		btnImageRestaurant.addPaintListener( new PaintListener() {
			  ...
			  public void paintControl( PaintEvent event ) {
			    ...
			    event.gc.drawImage(mapIcon, 26, 8);
			  }
			} );
