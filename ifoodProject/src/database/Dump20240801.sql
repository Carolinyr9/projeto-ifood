...
CREATE TABLE `prato` (
  ...
  `ngredientes` text CHARACTER SET utf16 COLLATE utf16_bin DEFAULT NULL,
  `preco` decimal(10,2) NOT NULL,
  `id_restaurante` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
BEGIN
    DELETE FROM pedido WHERE id = v_id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    INSERT INTO cardapio (id_restaurante, id_prato, id_produto)
    VALUES (v_id_restaurante, v_id_prato, v_id_produto);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `Inserir_Pedido`(
    IN `v_status` VARCHAR(255),
    IN `v_id_carrinho` INT,
    IN `v_id_cliente` INT,
    IN `v_id_entregador` INT,
    IN `v_data_pedido` TIMESTAMP,
    IN `v_data_atualizacao` TIMESTAMP
)
BEGIN
    INSERT INTO pedido (status, id_carrinho, id_cliente, id_entregador, data_pedido, data_atualizacao)
    VALUES (v_status, v_id_carrinho, v_id_cliente, v_id_entregador, v_data_pedido, v_data_atualizacao);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    INSERT INTO prato (nome, descricao, ingredientes, preco, id_restaurante)
    VALUES (v_nome, v_descricao, v_ingredientes, v_preco, v_id_restaurante);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
    INSERT INTO produto (nome, descricao, preco, id_restaurante)
    VALUES (v_nome, v_descricao, v_preco, v_id_restaurante);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2024-08-01 22:11:07
