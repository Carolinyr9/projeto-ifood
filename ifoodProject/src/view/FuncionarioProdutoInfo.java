...
public class FuncionarioProdutoInfo extends Composite {
	...
	/*Variável para exibir o campo de ingredientes caso o tipo do produto a ser editado seja Prato */
    ...
    /*Fazer a função para pegar os dados do prato para colocar nos campos abaixo*/

    public FuncionarioProdutoInfo(Composite parent, MainPage mainPage) {
		...
		lblTelaTitulo.setText("Editar Prato");
		...
		if(tipoProduto == "prato") {
			...
			/*Colocar aqui os ingreditentes do prato*/
			txtIngredientes.setText("a");
		...
		/* Colocar aqui a descrição do prato */
		txtDescricao.setText("a");
		...
		btnConcluir.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(tipoProduto == "prato"){
					/* Colocar aqui as funções para editar um prato no cardápio
